                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        @if ($verification->submittedFile)
                                            <a href="{{ Storage::url($verification->submittedFile) }}" target="_blank"
                                                class="text-blue-600 hover:text-blue-900 title"
                                        ...
                                        @if ($verification->status === 'pending')
                                            <button wire:click="edit({{ $verification->courseVerificationID }})"
                                                class="text-indigo-600 hover:text-indigo-900" title="Edit application">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-8 text-center text-gray-500">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-sm">Click "Apply for Verification" to submit your first
                                            application.</p>
                                    </div>
                                </td>
                            </tr>
